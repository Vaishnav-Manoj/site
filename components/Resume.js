        ...
        <div class="flex-auto lg:w-8/12 pt-10 px-5 lg:pl-16 text-lg">
          ...
          <div class="mb-8">
            ...
            <div class="mb-8">
              ...
              <div class="ml-3"> One of the biggest discord bots in the world with over one million users <div class="flex flex-wrap mt-2 text-sm font-bold">
            ...
            <div class="mb-8">
              ...
              <div class="ml-3"> One of the biggest community driven collection of discord server templates <div class="flex flex-wrap mt-2 text-sm font-bold">
                  <div class="px-2 py-1 bg-gray-200 rounded-md mr-2">Python</div>
            ...
            <div class="mb-8">
              ...
              <div class="ml-3"> A no-code platform for discord bots that allows its users to create their own bots <div class="flex flex-wrap mt-2 text-sm font-bold">
            ...
            <div class="pb-16">
              ...
              <div class="ml-3"> A tool that allows thousands of users to create custom messages for their discord server <div class="flex flex-wrap mt-2 text-sm font-bold">
                  <div class="px-2 py-1 bg-gray-200 rounded-md mr-2">VueJS</div>
